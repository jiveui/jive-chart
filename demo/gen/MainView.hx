...
class MainView extends org.aswing.JWindow implements jive.DataContextControllable<MainViewModel> {
    ...
    inline function get_aSColor__2():org.aswing.ASColor {
        /* declarations/MainView.xml:30 characters: 21-28 */
        var res = new org.aswing.ASColor();
        /* declarations/MainView.xml:30 characters: 30-33 */
        res.rgb = 0x000000;
        return res;
    }

    inline function get_chartUI__0():jive.chart.ChartUI {
        /* declarations/MainView.xml:32 characters: 21-34 */
        var res = new jive.chart.ChartUI();
        return res;
    }

    inline function get_intDimension__1():org.aswing.geom.IntDimension {
        /* declarations/MainView.xml:34 characters: 21-38 */
        var res = new org.aswing.geom.IntDimension();
        /* declarations/MainView.xml:34 characters: 40-45 */
        res.width = 350;
        /* declarations/MainView.xml:34 characters: 52-58 */
        res.height = 300;
        return res;
    }

    function get_chart1():jive.chart.Chart {
        /* declarations/MainView.xml:28 characters: 13-24 */
        ...
        /* declarations/MainView.xml:28 characters: 38-49 */
        res.constraints = org.aswing.BorderLayout.CENTER;
        /* declarations/MainView.xml:29 characters: 17-27 */
        res.foreground = get_aSColor__2();
        /* declarations/MainView.xml:32 characters: 17-19 */
        res.ui = get_chartUI__0();
        /* declarations/MainView.xml:33 characters: 17-30 */
